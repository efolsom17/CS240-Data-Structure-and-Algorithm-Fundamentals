...
2. The number of pegs(rods) must be greater than or equal to the number of disks. Else we would not be able to solve the puzzle.
...
If there are more than 3 rods, we will find the number of auxillary rods and then use that information to determine how we move disks between rods. The important piece will be 
