...
4. Implement a Levenshtein distance algorithm to compute the edit distance between two words.
   ...
   To implement a Levenshtein distance algorithm to calculate the edit distance between two strings I first went to [Wikipedia](https://en.wikipedia.org/wiki/Levenshtein_distance). The piecewise representation of this algorithm made a lot of sense to me, so I decided to implement it in python as best I could directly from the piecewise function.
