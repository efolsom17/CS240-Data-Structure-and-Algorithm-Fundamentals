...
ind_numbers<-as.integer(round(runif(n,0,1998)))#drawing random indicies from a discrete uniform(0,1998) dist.
...
for i in range(0 ,len(ind_data)-1):
   _,_, ops = binary_search(numbers[ind_data[i]], numbers)
